...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "BSGOLD_POST — Daily Gold Rate Posters for Jewellers" },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/assets/app-logo.png" },
      { rel: "shortcut icon", href: "/assets/app-logo.png" },
      { rel: "apple-touch-icon", href: "/assets/app-logo.png" },
